...
const FALLBACK_PLATFORMS: PlatformOption[] = [
  { id: "facebook_messenger", display_name: "Facebook Messenger", category: "social", status: "active", icon_name: "Facebook", brand_color: "#1877F2", description: "Responde mensajes de tus pÃ¡ginas de Facebook con IA", order: 1 },
  { id: "instagram_dms", display_name: "Instagram DMs", category: "social", status: "coming_soon", icon_name: "Instagram", brand_color: "#E1306C", description: "Gestiona mensajes directos de Instagram automÃ¡ticamente", order: 2 },
  ...
  { id: "telegram", display_name: "Telegram", category: "messaging", status: "coming_soon", icon_name: "Send", brand_color: "#0088cc", description: "Conecta tu bot de Telegram para atenciÃ³n automÃ¡tica", order: 4 },
  ...
  { id: "sms", display_name: "SMS / MMS", category: "traditional", status: "coming_soon", icon_name: "MessageCircle", brand_color: "#8B5CF6", description: "EnvÃ­a y recibe mensajes de texto con clientes", order: 9 },
];
...
export default function Channels() {
  ...
  useEffect(() => {
    const handler = (event: MessageEvent) => {
      ...
      if (event.data?.type === "channel-connected") {
        loadData();
        toast.success("Â¡Canal conectado exitosamente!");
      }
    };
  ...
  const handleNotify = (platformId: string, displayName: string) => {
    ...
    toast.success(`Te avisaremos cuando ${displayName} estÃ© disponible ðŸš€`);
  };
  ...
  const statusBadge = (status: PlatformOption["status"]) => {
    switch (status) {
      ...
      case "coming_soon":
        return <Badge className="bg-muted text-muted-foreground border-border/40 text-[10px]">PrÃ³ximamente</Badge>;
    }
  };
  ...
  return (
    <div className="h-full overflow-auto">
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        {/* Section A â€” Connected channels */}
          ...
          {channels.length === 0 ? (
            ...
            >
              ...
              <p className="text-sm font-medium text-foreground mb-1">
                AÃºn no tienes canales conectados para esta marca
              </p>
        ...
        {/* Section B â€” Available platforms */}
        <section>
          <h2 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground mb-4">
            Disponibles
          </h2>
                ...
                return (
                  ...
                  >
                    ...
                    {isComingSoon && (
                      ...
                      >
                        {isNotified ? (
                          <><Check size={14} className="mr-1.5" /> NotificaciÃ³n activa</>
                        ) : (
