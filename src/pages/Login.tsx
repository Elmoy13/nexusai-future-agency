...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(false);
    setError("Acceso denegado: Nodo no reconocido. Contacta a soporte o únete a la lista de espera.");
  };
        ...
        <div className="glass-strong rounded-2xl p-8 glow-border">
          ...
          <div className="space-y-3 mb-6">
            <button
              onClick={handleOAuth}
              disabled={loading}
              className="w-full glass rounded-xl py-3 px-4 text-sm font-medium text-foreground hover:bg-secondary/50 transition-colors flex items-center justify-center gap-3 disabled:opacity-50"
            >
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-xs text-muted-foreground font-mono">o usar credenciales de sistema</span>
            <div className="flex-1 h-px bg-border" />
          </div>
