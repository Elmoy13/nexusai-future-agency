...
const Community = () => {
  ...
  const handleToggleMode = async () => {
    ...
    try {
      const res = await fetch(
        `https://arise-meter-watson-thu.trycloudflare.com/api/v1/conversations/${selectedConversationId}/mode`,
        {
          method: "PATCH",
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const res = await fetch("https://arise-meter-watson-thu.trycloudflare.com/api/v1/messages/send", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
